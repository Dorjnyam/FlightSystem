...
namespace FlightSystem.Test.Server;

public class FlightSystemServerTests : IDisposable
{
    ...
    public FlightSystemServerTests()
    {
    ...
    public async Task DatabaseContext_SaveChanges_ShouldWork()
    {
        ...
        var flight = new Flight
        {
            ...
            DepartureAirport = "UB",
            ArrivalAirport = "DXB",
            ScheduledDeparture = DateTime.UtcNow.AddHours(9),
            ScheduledArrival = DateTime.UtcNow.AddHours(13),
            Status = FlightStatus.Scheduled,
            GateNumber = "G8"
        };
